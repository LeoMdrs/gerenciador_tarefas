...
def cadastrar_tarefa(request):
    #Verificando se requisição é Post (Se usuario clicar no input, entra no metodo POST)
    if request.method == "POST":
        form_tarefa = TarefaForm(request.POST)
        #Verificando se dados passados do form são válidos
    ...
    #Quando abre a página
        ...
        #Passando formulário para view rendeizar
...
def editar_tarefa(request, id):
    ...
    #VERIFICAR SE O USUARIO LOGADO É O DONO DA TAREFA
